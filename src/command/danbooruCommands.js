    ...
    danbooru: new Command(
        ...
        async (msg, parsedMsg, from, channel, command, roles, messageId, targetMessageId, client, attachmentUrl) => {
            ...
            if (result) {
                ...
                const formattedEvent = `[ ${process.env.BOTNAME} responds to the command by searching "${parsedMsg}" on the hentai website "danbooru" and sending one of the pictures to ${from}. The picture has the tags "${result.tag_string_general}" ]`
                return {
